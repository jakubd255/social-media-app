...
const getPostsExplore = async (myId: string, page: number, pageSize: number, input: string) => {
            ...
            $and: [
                ...
                {$or: [
                    {$and: [
                        {groupId: {$ne: null}},
                        {$or: [
                            {"groupData.members._id": loggedInUserId},
                            {"groupData.private": {$ne: true}}
                        ]}
                    ]},
                    {$and: [
                        {$or: [
...
export default getPostsExplore;